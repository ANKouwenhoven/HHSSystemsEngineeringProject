...
//     if (sensorValues[i] > LINE_VALUE_GREY) {
//       perceivedLineColors[i] = "Black";
//     } else if (sensorValues[i] > LINE_VALUE_BROWN) {
//       perceivedLineColors[i] = "Grey";
//     } else if (sensorValues[i] > LINE_VALUE_GREEN) {
//       perceivedLineColors[i] = "Brown";
//     } else if (sensorValues[i] > LINE_VALUE_EMPTY) {
...
// void printToSerial() {
//   for (int i = 0; i < 5; i++) {
//     printInFormat(i + 1, sensorValues[i]);
//   }
